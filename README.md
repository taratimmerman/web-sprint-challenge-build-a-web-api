...
1. The core features of Node.js and Express and why they are useful.
    -- Node.js made it possible to create a JavaScript backend and Express is a light framework. Express' core features are Middleware, Routing, Helpers, and Views. Express developers left a lot up to our discretion and we can make the app as simple or robust as we choose.
